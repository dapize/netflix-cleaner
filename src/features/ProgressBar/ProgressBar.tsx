		...
		<div class="flex justify-between items-center w-full gap-x-4">
			...
			>
				<div class="h-[6px] bg-white/30 rounded-[3px] relative w-full transition-all duration-200 group-hover:h-[10px]">
					<div class="h-full rounded-[3px] bg-white opacity-45 absolute left-0 top-0 w-[250px]"></div>
					<div class="h-full rounded-[3px] bg-[#e50914] absolute left-0 top-0" style={{ width: `${percentage}%` }}>
						<button
