...
export const ProgressBar = () => {
  ...
  return (
    <div class="flex justify-between items-center w-full mb-2">
      <div class="h-[6px] bg-white/30 rounded-[3px] relative w-[calc(100%-50px)]">
        <div class="h-full rounded-[3px] bg-[#e50914]" style={{ width: `${percentage}%` }}></div>
      </div>
      <span class="font-[22px] text-white shrink-0 w-[50px] flex justify-end items-center">{timeLeft}</span>
    </div>
  )
}
